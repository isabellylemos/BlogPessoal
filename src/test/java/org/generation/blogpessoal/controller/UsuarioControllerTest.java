...
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)//rodar em cache
@TestInstance(TestInstance.Lifecycle.PER_CLASS)  //classe de texte
@TestMethodOrder(MethodOrderer.OrderAnnotation.class) //ordem de texte
